...
exports.checkAnyCollectExists = async function (req, res, next) {
...
exports.checkUserCollectExists = async function (req, res, next) {
  const { userId, bookmarkId } = req.params;
  ...
  try {
    ...
    res.status(500).json({
      error: "해당 유저의 책갈피 즐겨찾기 상태를 불러오는데 실패하였습니다",
    });
  }
};
